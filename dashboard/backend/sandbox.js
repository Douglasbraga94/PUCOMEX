...
// 			var ambiente = 'val'
// 			break
// 		case 'hom.pucomex.serpro.gov.br':
// 			var ambiente = 'hom'
// 			break
// 	}
...
function handler (event, context, callback) {
	...
	switch(host) {
		...
		case 'val.portalunico.siscomex.gov.br':
			var ambiente = 'val'
			break
		case 'hom-mdic.pucomex.serpro.gov.br':
			var ambiente = 'hom'
			break
	}
...
// var base_url = 'https://hom-mdic.pucomex.serpro.gov.br/talpco/api';
var base_url = 'https://hom.pucomex.serpro.gov.br/talpco/api';
...
// return handler({
// 	url: 'https://hom.pucomex.serpro.gov.br/cct/api/ext/deposito-carga/consultar-estoque-pos-acd?numeroDUE=17BR0000445540',
// 	verb: 'GET',
// 	perfil: 'IMPEXP',
...
return handler({
	// url: 'https://hom.pucomex.serpro.gov.br/catp/api/ext/operador-estrangeiro',
	// url: 'https://hom.pucomex.serpro.gov.br/catp/api/ext/produto',
	// url: 'https://hom.pucomex.serpro.gov.br/talpco/api/ext/lpco/modelo/E00374',
	// url: 'https://hom.pucomex.serpro.gov.br/talpco/api/ext/lpco/modelo/E00374/02071400',
	// url: 'https://hom.pucomex.serpro.gov.br/talpco/api/ext/lpco',
	// url: 'https://hom.pucomex.serpro.gov.br/talpco/api/ext/lpco/situacao/E1800000110',
